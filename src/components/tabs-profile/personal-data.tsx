  ...
  return (
    <div className="flex-1 px-6 py-8 bg-white">
      <div className="flex flex-wrap gap-x-4 gap-y-6">
        ...
        <div className="w-full max-w-[132px] flex flex-col gap-1">
        ...
        <div className="w-full flex flex-wrap gap-x-4 gap-y-6">
          ...
          <div className="w-full flex flex-col gap-1">
            ...
            <textarea
              ...
              disabled={!isEditing}
              className="h-[150px] md:h-20 px-3 py-2 text-sm text-gray-900 border border-[#b1b3b5] focus:outline-[#9c9d9e] placeholder:text-[#9c9d9e] focus-within:border-[#caccce] disabled:text-[#8181a5] disabled:bg-[#e9ecef] disabled:border-[#dddfe1] disabled:placeholder:text-[#8181a5]"
